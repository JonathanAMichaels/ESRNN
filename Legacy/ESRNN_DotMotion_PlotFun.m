...
if evalOptions(1) >= 2
    ...
    for condCount = 1:length(plotStats.bigZ1)
        h1 = filledCircle([plotStats.targ{condCount}(1,1) plotStats.targ{condCount}(2,1)], 0.05, 100, [1 1 1]);
        h2 = filledCircle([plotStats.targ{condCount}(1,end) plotStats.targ{condCount}(2,end)], 0.05, 100, [0.9 0.9 0.9]);
