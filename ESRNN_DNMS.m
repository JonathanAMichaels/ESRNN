...
try
    if ispc
       ...
       % baseDir = '/Users/jonathanamichaels/Desktop/P';
         baseDir = '/Users/jonathanamichaels/Desktop/jmichaels/Projects/DNMS';
    end
...
inpFun = @ESRNN_DNMS_inpFun;
%targetFun = @ESRNN_defaulttargetfun;
...
for reps = 1:10
    ...
    [inp, fitnessFunInputs, targetFunPassthrough] = ESRNN_DNMS_inpFun;
    % run model
